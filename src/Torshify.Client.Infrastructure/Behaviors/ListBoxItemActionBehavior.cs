...
{
    public class ListBoxItemActionBehavior : Behavior<ListBox>
    {
        #region Fields

        public static readonly DependencyProperty CommandParameterProperty =
            DependencyProperty.Register("CommandParameter", typeof(object), typeof(ListBoxItemActionBehavior),
                                        new FrameworkPropertyMetadata((object)null));
        public static readonly DependencyProperty CommandProperty =
            DependencyProperty.Register("Command", typeof(ICommand), typeof(ListBoxItemActionBehavior),
        ...
        private void OnKeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                ...
                if (element != null)
                {
                    var row = element.FindVisualAncestorByType<ListBoxItem>();
