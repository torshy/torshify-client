...
namespace Torshify.Client.Infrastructure.Controls.Standard
{
    internal abstract class CornerRadiusAnimationBase : AnimationTimeline
    {
        #region Constructors
        ...
        public new CornerRadiusAnimationBase Clone()
        {
            return (CornerRadiusAnimationBase)base.Clone();
        }
